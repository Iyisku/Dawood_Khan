        ...
        <div className="w-full md:w-1/2">
          <form action="https://formsubmit.co/dawoodkhan3908@gmail.com" target="_blank" method="POST" className="space-y-4">
            ...
            <div className="flex gap-3  ">
              <button
                type="submit"
                className="bg-black text-white px-6 py-3 rounded border-black border-2 font-medium hover:text-black hover:cursor-pointer hover:bg-white"
              >
                Get In Touch
              </button>
              ...
              {/* LinkedIn Icon */}
              <a href="https://www.linkedin.com/in/muhammad-dawood-k-39880b229/" target="_blank" className="border border-gray-300 p-3 rounded flex items-center justify-center transition-colors duration-300 hover:bg-black hover:border-black hover:text-white">
