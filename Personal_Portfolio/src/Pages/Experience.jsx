...
import { FaGamepad, FaGoogle, FaMagento, FaTableTennis } from "react-icons/fa";
...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "As a C# Developer with Unity at Metal Heart Studio, I played a pivotal role in developing Engaging Games. I contributed to more than 2 Projects and Learned Industry Best Practices In programming.",
    ...
    },
    {
      ...
      Techused:
        "Html, Css, Js, Go, Azure, C# , Git, Github, Visual Studio, Figma, Discord, Slack",
    },
  ];
