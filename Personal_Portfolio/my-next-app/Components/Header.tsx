...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div
        className="m-2 text-white bg-[#000000] rounded-full mx-4 md:mx-8 lg:mx-14 px-8 py-2 relative"
      ...
      >
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-black z-50 mt-1 rounded-b-3xl py-4 shadow-lg animate-fadeIn">
